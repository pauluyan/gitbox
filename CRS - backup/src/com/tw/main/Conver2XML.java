...
//								logger.error("DOCREFID:" + acctholder.getDOCREFID() + ",Organisation NULL ResCountryCode");
...
//							logger.error("DOCREFID:" + acctholder.getDOCREFID() + ",ControllingPerson NULL ResCountryCode");
...
//							logger.error("DOCREFID:" + acctholder.getDOCREFID() + ",ControllingPerson NULL CountryCode");
...
//							logger.error("DOCREFID:" + acctholder.getDOCREFID() + ",ControllingPerson NULL AddressFree");
//								addressFreeElement = objectFactory.createAddressTypeAddressFree(" ");
						}
						addressFreeElement = objectFactory
