...
public class DocSpecType {
	...
	public static void main(String[] args) {
		...
		//---------------------------------------------
		docSpecType.setDocTypeIndic(OECDDocTypeIndicEnumType.OECD_0);
		docSpecType.getDocTypeIndic();
		//------------------------------------------------
		docSpecType.setDocRefID("文檔編號");
		docSpecType.getDocRefID();
		//-------------------------------------------------
		docSpecType.setCorrDocRefID("更正文檔編號");
		docSpecType.getCorrDocRefID();
	}
