 ...
 *       &lt;sequence>
 *         &lt;element name="Street" type="{urn:oecd:ties:TWcommontypesfatcacrs:v1}Char100_Type" minOccurs="0"/>
 *         &lt;element name="BuildingIdentifier" type="{urn:oecd:ties:TWcommontypesfatcacrs:v1}Char70_Type" minOccurs="0"/>
 *         &lt;element name="SuiteIdentifier" type="{urn:oecd:ties:TWcommontypesfatcacrs:v1}Char70_Type" minOccurs="0"/>
 *         &lt;element name="FloorIdentifier" type="{urn:oecd:ties:TWcommontypesfatcacrs:v1}Char70_Type" minOccurs="0"/>
 *         &lt;element name="DistrictName" type="{urn:oecd:ties:TWcommontypesfatcacrs:v1}Char70_Type" minOccurs="0"/>
 *         &lt;element name="POB" type="{urn:oecd:ties:TWcommontypesfatcacrs:v1}Char70_Type" minOccurs="0"/>
 *         &lt;element name="PostCode" type="{urn:oecd:ties:TWcommontypesfatcacrs:v1}Char70_Type" minOccurs="0"/>
 *         &lt;element name="City" type="{urn:oecd:ties:TWcommontypesfatcacrs:v1}Char70_Type"/>
 *         &lt;element name="CountrySubentity" type="{urn:oecd:ties:TWcommontypesfatcacrs:v1}Char70_Type" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "AddressFix_Type", namespace = "urn:oecd:ties:TWcommontypesfatcacrs:v1", propOrder = {
    "street",
    "buildingIdentifier",
    "suiteIdentifier",
    "floorIdentifier",
