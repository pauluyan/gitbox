 ...
 *         &lt;element name="TIN" type="{urn:oecd:ties:TWcommontypesfatcacrs:v1}TIN_Type" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                   &lt;element name="City" type="{urn:oecd:ties:TWcommontypesfatcacrs:v1}Char70_Type" minOccurs="0"/>
 *                   &lt;element name="CitySubentity" type="{urn:oecd:ties:TWcommontypesfatcacrs:v1}Char70_Type" minOccurs="0"/>
 ...
 *                             &lt;element name="FormerCountryName" type="{urn:oecd:ties:TWcommontypesfatcacrs:v1}Char70_Type"/>
 *                           &lt;/choice>
 *                         &lt;/restriction>
 *                       &lt;/complexContent>
 *                     &lt;/complexType>
...
public class PersonPartyType {
	public static void main(String[] args) {
		...
		//-----------------------------------------------------
		partyType.getResCountryCode().add(CountryCodeType.TW);
		//-----------------------------------------------------
    ...
    public static class BirthInfo {
    	public static void main(String[] args) throws DatatypeConfigurationException {
			...
			birthInfo.setBirthDate(xgcl1);
			birthInfo.getBirthDate();
			//----------------------------------------------------
			birthInfo.setCity("出生城市 ");
			birthInfo.getCity();
			//----------------------------------------------------
			birthInfo.setCitySubentity("出生城市行政區域");
			birthInfo.getCitySubentity();
			//----------------------------------------------------
			BirthInfo.CountryInfo countryInfo = new BirthInfo.CountryInfo();
			birthInfo.setCountryInfo(countryInfo);
			birthInfo.getCountryInfo();
        ...
        public static class CountryInfo {
        	public static void main(String[] args) {
				...
				countryInfo.getFormerCountryName();
			}
