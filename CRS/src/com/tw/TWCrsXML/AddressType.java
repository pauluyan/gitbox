 ...
 *         &lt;choice>
 *           &lt;element name="AddressFree" type="{urn:oecd:ties:TWcommontypesfatcacrs:v1}Char400_Type"/>
 *           &lt;sequence>
 *             &lt;element name="AddressFix" type="{urn:oecd:ties:TWcommontypesfatcacrs:v1}AddressFix_Type"/>
 *             &lt;element name="AddressFree" type="{urn:oecd:ties:TWcommontypesfatcacrs:v1}Char400_Type" minOccurs="0"/>
 *           &lt;/sequence>
 *         &lt;/choice>
 *       &lt;/sequence>
...
@XmlType(name = "Address_Type", namespace = "urn:oecd:ties:TWcommontypesfatcacrs:v1", propOrder = {
    "content"
})
public class AddressType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "CountryCode", namespace = "urn:oecd:ties:TWcommontypesfatcacrs:v1", type = JAXBElement.class),
        @XmlElementRef(name = "AddressFree", namespace = "urn:oecd:ties:TWcommontypesfatcacrs:v1", type = JAXBElement.class),
        @XmlElementRef(name = "AddressFix", namespace = "urn:oecd:ties:TWcommontypesfatcacrs:v1", type = JAXBElement.class)
    })
     ...
     * line 181 of file:/C:/Users/user/eclipse-workspace/XSDturn/src/main/java/TWCommonTypesFatcaCrs_v1.0.xsd
     * line 178 of file:/C:/Users/user/eclipse-workspace/XSDturn/src/main/java/TWCommonTypesFatcaCrs_v1.0.xsd
     * <p>
